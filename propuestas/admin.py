...
class PropuestaResource(resources.ModelResource):
    ...
    tema = fields.Field(attribute='tema', column_name='Tema Principal')
    otros_temas = fields.Field(attribute='otros_temas', column_name='Sub Temas')
    tema_extra = fields.Field(attribute='tema_extra', column_name='Tema Extra')
    pais = fields.Field(attribute='pais', column_name='País')
    region = fields.Field(attribute='region', column_name='Región')
    comuna = fields.Field(attribute='comuna', column_name='Comuna')
