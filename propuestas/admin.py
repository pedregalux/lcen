...
# class AutorForeignKeyWidget(ForeignKeyWidget):
#     def get_queryset(self, value, row):
#         return User.objects.filter(
#             nombre__iexact=row["nombre"]
#         )
...
class PropuestaResource(resources.ModelResource):
        ...
        # autor2 = fields.Field(attribute='autor', widget=ForeignKeyWidget(Organizacion, field='nombre_perfil'), column_name='Autor2')
